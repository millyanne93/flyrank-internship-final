...
When I started this internship, I thought I understood what backend engineering meant. I could build APIs, work with databases, and deploy basic applications. But I didn't yet understand what it meant to build software for the open internet — where you can't trust the input, you can't control the traffic, and you can't predict what will break next. That's what changed.
...
If I had more time, I'd extend the widget platform with webhook delivery and a real-time dashboard. For the image engine, I'd add multiple model comparison and automatic alt text generation. For the portfolio, I'd add conversation persistence and rate limiting to the chat agent.
